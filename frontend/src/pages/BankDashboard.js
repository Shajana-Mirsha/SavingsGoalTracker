            ...
            <div style={{
                ...
                <form onSubmit={handleSetup} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                    ...
                    <button
                        ...
                        style={{
                            padding: "15px", borderRadius: "12px", background: "#2563eb",
                            color: "white", border: "none", fontWeight: "700",
                            cursor: "pointer", fontSize: "15px", marginTop: "10px"
                        }}
                    >
        ...
        <div style={{ maxWidth: "1000px", margin: "0 auto", padding: "20px" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "30px" }}>
                ...
                <Link to="/dashboard" style={{
                    textDecoration: "none", color: "#64748b", fontWeight: "600",
                ...
                <div style={{
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "40px" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: "8px", opacity: 0.9 }}>
                            <ShieldCheck size={18} />
                            <span style={{ fontWeight: "600", fontSize: "14px", letterSpacing: "1px" }}>
                                VAULT BANK SECURE
                            </span>
                        </div>
                    ...
                    <div style={{ marginBottom: "30px" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
                            <p style={{ margin: 0, fontSize: "12px", opacity: 0.7, letterSpacing: "1px" }}>
                                TOTAL BALANCE
                            </p>
                            <button
                        ...
                        <h2 style={{
                            margin: 0, fontSize: "42px", fontWeight: "700",
                            letterSpacing: showBalance ? "0" : "4px"
                        }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
                        <div>
                            <p style={{ margin: "0 0 5px 0", fontSize: "10px", opacity: 0.7, letterSpacing: "1px" }}>
                                ACCOUNT NUMBER
                            </p>
                    ...
                    <div style={{
                        ...
                        <div style={{ display: "flex", gap: "15px" }}>
                            <button
                                ...
                                style={{
                                    flex: 1, padding: "15px", border: "1px solid #e2e8f0", borderRadius: "12px",
                                    background: showAddMoney ? "#eff6ff" : "white", cursor: "pointer",
                                    transition: "all 0.2s", display: "flex", flexDirection: "column",
                                    alignItems: "center", gap: "10px"
                                }}
                            >
                                <div style={{ background: "#dbeafe", color: "#2563eb", padding: "10px", borderRadius: "50%" }}>
                                    <Plus size={20} />
                                </div>
                            ...
                            <button
                                ...
                                style={{
                                    flex: 1, padding: "15px", border: "1px solid #e2e8f0", borderRadius: "12px",
                                    background: showWithdraw ? "#fff1f2" : "white", cursor: "pointer",
                                    transition: "all 0.2s", display: "flex", flexDirection: "column",
                                    alignItems: "center", gap: "10px"
                                }}
                            >
                                <div style={{ background: "#fee2e2", color: "#ef4444", padding: "10px", borderRadius: "50%" }}>
                                    <ArrowRight size={20} />
                                </div>
                            ...
                            <div style={{ marginTop: "20px", paddingTop: "20px", borderTop: "1px solid #f1f5f9" }}>
                                ...
                                <form onSubmit={handleWithdraw} style={{ display: "flex", gap: "10px" }}>
                                    <input
                                        ...
                                        style={{
                                            flex: 1, padding: "12px", borderRadius: "8px",
                                            border: "1px solid #fca5a5", outline: "none", fontSize: "14px"
                                        }}
                                        autoFocus
                                    />
                                    <button type="submit" style={{
                                        padding: "0 20px", background: "#ef4444", color: "white",
                                        borderRadius: "8px", border: "none", cursor: "pointer", fontWeight: "700"
                                    }}>Withdraw</button>
                                </form>
                            </div>
                        ...
                        {message && (
                            <div style={{
                                ...
                                borderRadius: "8px", fontSize: "13px", fontWeight: "700", textAlign: "center"
                            }}>
                                {message}
                            </div>
                        )}
